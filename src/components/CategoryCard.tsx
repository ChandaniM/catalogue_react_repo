...
const CategoryCard = ({ category }: CategoryCardProps) => {
  return (
    ...
    >
      {/* Fixed image height */}
      <div className="h-40 w-full shrink-0 overflow-hidden bg-gray-100 sm:h-44">
        {category.coverImage ? (
          <img
            src={category.coverImage}
            alt={category.name}
          ...
          <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-[var(--primary-light)] to-[var(--primary)] text-white">
