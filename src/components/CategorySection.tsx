  ...
  return (
    <section className="max-w-7xl mx-auto px-6 mt-8">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-6">
        <div>
          <p className="text-xs uppercase tracking-[0.3em] text-gray-500 mb-2">Browse by folder</p>
          <h2 className="text-xl font-semibold text-black">Shop by category</h2>
        </div>
        <button className="inline-flex items-center gap-2 text-sm font-semibold uppercase text-gray-700">
